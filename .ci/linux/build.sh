...
amd64 | "")
    ...
    export EXTRA_CMAKE_FLAGS=(-DYUZU_BUILD_PRESET=v3 -DYUZU_USE_EXTERNAL_SDL2=OFF -DYUZU_USE_BUNDLED_SDL2=ON)
    ;;
steamdeck | zen2)
...
legacy)
    ...
    export EXTRA_CMAKE_FLAGS=(-DYUZU_BUILD_PRESET=generic -DYUZU_USE_EXTERNAL_SDL2=OFF -DYUZU_USE_BUNDLED_SDL2=ON)
    ;;
aarch64)
...
armv9)
    ...
    export EXTRA_CMAKE_FLAGS=(-DYUZU_BUILD_PRESET=armv9 -DYUZU_USE_EXTERNAL_SDL2=OFF -DYUZU_USE_BUNDLED_SDL2=ON)
    ;;
native)
    echo "Making native build of Eden"
    ARCH="$(uname -m)"
    ARCH_FLAGS="-march=native -mtune=native"
    export EXTRA_CMAKE_FLAGS=(-DYUZU_BUILD_PRESET=native -DYUZU_USE_EXTERNAL_SDL2=OFF -DYUZU_USE_BUNDLED_SDL2=ON)
    ;;
*)
